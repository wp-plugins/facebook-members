...
Plugin URI: http://icrunchies.com/facebook-members/
...
function as_facebook_mem_likebox()
{
	...
	{
		$sponserlink_profile = '<div align="left">- <a href="http://icrunchies.com/facebook-members/" title="Facebook Members WordPress Plugin" target="_blank"> <font size="1">' . 'Facebook Members WordPress Plugin' . '</font></a></div>';
	}
