...
function as_facebook_mem_options_page() {
	...
	$help_icon = '<img border="0" src="'.$icon_url.'/wp-content/plugins/facebook-members/help.gif" /> ';
...
<br>
			...
			<div class="postbox">
				<h3>Facebook Members - Recommendation Bar Setting <?=$new_icon?></h3>
				<div>
				...
				<tr valign="top">
                      ...
                      <td><textarea name="as_facebook_mem_reco_readtime" cols="18" rows="1"><?php echo get_option('as_facebook_mem_reco_readtime'); ?></textarea> Number of seconds plugin will wait before expands. (1 to 30)
                      </td> 
				</tr> 
				<tr valign="top" class="alternate">
          			<th scope="row" style="width:29%;"><label>Verb to Display?</label></th>
                      <td><textarea name="as_facebook_mem_reco_verb" cols="18" rows="1"><?php echo get_option('as_facebook_mem_reco_verb'); ?></textarea> i.e like/recommend
                      </td>
				</tr>
				<tr valign="top">
          			<th scope="row" style="width:29%;"><label>Side?</label></th>
                      <td><textarea name="as_facebook_mem_reco_side" cols="18" rows="1"><?php echo get_option('as_facebook_mem_reco_side'); ?></textarea> i.e left/right
                      </td> 
				</tr> 
					<tr valign="top" class="alternate">
