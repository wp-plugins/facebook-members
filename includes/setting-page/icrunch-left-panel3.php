    ...
    <div>
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td><textarea id="styled" name="as_facebook_mem_widget_title" cols="18"
                              rows="1"><?php echo get_option('as_facebook_mem_widget_title'); ?></textarea></td>
            </tr>
            <tr valign="top" class="alternate">
                <th scope="row" style="width:29%;"><label>Facebook Page Name</label></th>
                <td><textarea id="styled" name="as_facebook_mem_widget_page_name" cols="18"
                              rows="1"><?php echo get_option('as_facebook_mem_widget_page_name'); ?></textarea>
                    &nbsp;<?=$fb_pagename1?>
                    <br>
            ...
            <tr valign="top">
                ...
                <td><textarea id="styled" name="as_facebook_mem_widget_width" cols="18"
                              rows="1"><?php echo get_option('as_facebook_mem_widget_width'); ?></textarea></td>
            </tr>
            <tr valign="top" class="alternate">
                <th scope="row" style="width:29%;"><label>Widget Height</label></th>
                <td><textarea id="styled" name="as_facebook_mem_widget_height" cols="18"
            ...
            <tr valign="top" class="alternate">
                ...
                <td>
                    <input name="as_facebook_mem_widget_stream" type="radio"
                           value="true" <?php checked('true', $as_facebook_mem_widget_stream); ?> />
                    &nbsp;YES

                    <input name="as_facebook_mem_widget_stream" type="radio"
                           value="false" <?php checked('false', $as_facebook_mem_widget_stream); ?> />
                    &nbsp;NO (default)
                    &nbsp;<?=$fb_showstream1?>
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input name="as_facebook_mem_widget_faces" type="radio"
                           value="true" <?php checked('true', $as_facebook_mem_widget_faces); ?> />
                    &nbsp;YES (default)

                    <input name="as_facebook_mem_widget_faces" type="radio"
                           value="false" <?php checked('false', $as_facebook_mem_widget_faces); ?> />
                    &nbsp;NO
            ...
            <tr valign="top" class="alternate">
                ...
                <td>
                    <input name="as_fbmembers_show_sponser_link"
                           type="checkbox"<?php if (get_option('as_fbmembers_show_sponser_link') != '-1') echo 'checked="checked"'; ?>
                           value="1"/> <code>Check</code> to hide promotion link after widget
                </td>
            </tr>
