    ...
    <div>
        <table class="form-table">
            ...
            <tr valign="top" class="alternate">
                ...
                <td><textarea id="styled" name="as_facebook_mem_reco_appid" cols="18"
                              rows="1"><?php echo get_option('as_facebook_mem_reco_appid'); ?></textarea>
                    &nbsp;<?=$fb_recco?>
                    <br>
                    <a href="http://Crunchify.com/step-by-step-direction-to-get-facebook-appid-for-facebook-members-plugin/"
            ...
            <tr valign="top">
                ...
                <td><textarea id="styled" name="as_facebook_mem_reco_readtime" cols="18"
                              rows="1"><?php echo get_option('as_facebook_mem_reco_readtime'); ?></textarea>
                    &nbsp;<?=$fb_readtime?>
                </td>
            </tr>
            <tr valign="top" class="alternate">
                <th scope="row" style="width:29%;"><label>Verb to Display?</label></th>
                <td><textarea id="styled" name="as_facebook_mem_reco_verb" cols="18"
                              rows="1"><?php echo get_option('as_facebook_mem_reco_verb'); ?></textarea> i.e
                    like/recommend
                </td>
            </tr>
            <tr valign="top">
                <th scope="row" style="width:29%;"><label>Side?</label></th>
                <td><textarea id="styled" name="as_facebook_mem_reco_side" cols="18"
                              rows="1"><?php echo get_option('as_facebook_mem_reco_side'); ?></textarea> i.e left/right
                </td>
            </tr>
            <tr valign="top" class="alternate">
